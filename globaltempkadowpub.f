      program globalmeankadow
c     program to calculate global mean temperature from Kadow et al
c     gridded data. See globaltemphadcrupub.f for full documentation
